...
/**
 * Official WhatsApp glyph. lucide-react has no WhatsApp icon, and the generic
 * speech bubble it ships doesn't read as "WhatsApp" to a visitor, so the mark
 * is inlined here. Uses currentColor so it inherits the surrounding text tone.
 */
